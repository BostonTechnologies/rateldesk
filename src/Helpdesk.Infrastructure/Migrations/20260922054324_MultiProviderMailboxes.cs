        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TransportKey = table.Column<string>(type: "character varying(1024)", maxLength: 1024, nullable: false),
                    ...
                    CreatedUnixMilliseconds = table.Column<long>(type: "bigint", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastSyncUnixMilliseconds = table.Column<long>(type: "bigint", nullable: true),
                    NextRetryUnixMilliseconds = table.Column<long>(type: "bigint", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExpiresUnixMilliseconds = table.Column<long>(type: "bigint", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AvailableUnixMilliseconds = table.Column<long>(type: "bigint", nullable: false),
                    LeaseExpiresUnixMilliseconds = table.Column<long>(type: "bigint", nullable: false),
                    LastErrorCode = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true),
                    DeliveryEventId = table.Column<Guid>(type: "uuid", nullable: true)
                },
                constraints: table =>
                {
